...
def test_stats_billing_log_view_is_correct(api_client, create_subscription):
    ...
    assert response.data == [
        {'currency': u'USD', 'values': [
            {'total': Decimal('20.00'), 'billing_date': '01/31/2017', 'id': 2}],
         'plan': u'Hydrogen', 'customer_name': u'Harry Potter'},
        {'currency': u'RON', 'values': [
            {'total': Decimal('10.00'), 'billing_date': '01/11/2017', 'id': 1}],
         'plan': u'Oxygen', 'customer_name': u'Harry Potter'},
        {'currency': u'USD', 'values': [
            {'total': Decimal('30.00'), 'billing_date': '02/20/2017', 'id': 4}],
         'plan': u'Enterprise', 'customer_name': u'Ron Weasley'},
        {'currency': u'RON', 'values': [
            {'total': Decimal('20.00'), 'billing_date': '01/31/2017', 'id': 3},
            {'total': Decimal('20.00'), 'billing_date': '01/31/2017', 'id': 3}],
...
def test_stats_document_view_is_correct(api_client, create_document):
    ...
    assert response.data == [
        {'currency': u'RON', 'issue_date': 'Aug 2017', 'values': [
            {'total': Decimal('101.00'), 'id': 1}],
         'customer_name': u'Harry Potter'},
        {'currency': u'RON', 'issue_date': 'Aug 2017', 'values': [
            {'total': 0, 'id': 2},
            {'total': Decimal('202.00'), 'id': 3}],
         'customer_name': u'Ron Weasley'},
        {'currency': u'RON', 'issue_date': 'Jul 2017', 'values': [
            {'total': Decimal('303.00'), 'id': 4}],
         'customer_name': u'Ron Weasley'}
    ]
...
def test_stats_transaction_view_is_correct(api_client, create_transaction):
    ...
    assert response.data == [
        {'currency': u'RON', 'created_at': 'Jul 2017', 'values': [
            {'total': Decimal('20.00'), 'id': 3}],
         'customer_name': u'Hermione Granger'},
        {'currency': u'RON', 'created_at': 'Sep 2017', 'values': [
            {'total': Decimal('10.00'), 'id': 1}],
         'customer_name': u'Hermione Granger'},
        {'currency': u'RON', 'created_at': 'Jul 2017', 'values': [
            {'total': Decimal('15.00'), 'id': 2},
