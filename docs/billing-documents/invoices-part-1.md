---
title: Invoices in Silver - Part 1
description: Detailed explanations of what is an Invoice in Silver, how to create one, as well as how to list all invoices and how to retrieve a single one.
linktitle: Invoices - Part 1
categories: [silver]
keywords: [silver]
menu:
  docs:
