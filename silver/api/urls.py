...
urlpatterns = patterns('',
    ...
    url(r'^invoices/(?P<invoice_pk>[0-9]+)/entries/$',
        views.BillingDocumentEntryCreate.as_view(),
        name='billingdocumententry-create'),
    url(r'^invoices/(?P<invoice_pk>[0-9]+)/entries/(?P<entry_id>[0-9]+)/$',
        views.BillingDocumentEntryUpdateDestroy.as_view(),
        name=' billingdocumententry-update'),
    url(r'^product-codes/$',
