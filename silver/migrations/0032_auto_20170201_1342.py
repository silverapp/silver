...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='customer',
            name='first_name',
            field=models.CharField(default='', help_text="The customer's first name.", max_length=128),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, max_length=256, null=True, help_text="It's a reference to be passed between silver and clients. It usually points to an account ID.", validators=[django.core.validators.RegexValidator(regex='^[^,]*$', message='Reference must not contain commas.')]),
        ),
        migrations.AlterField(
            model_name='customer',
            name='email',
        ...
        migrations.AlterField(
            model_name='invoice',
            name='proforma',
            field=models.ForeignKey(related_name='related_invoice', blank=True, to='silver.Proforma', null=True, on_delete=models.PROTECT),
        ),
        migrations.AlterField(
            model_name='plan',
            name='currency',
        ...
        migrations.AlterField(
            model_name='proforma',
            name='invoice',
            field=models.ForeignKey(related_name='related_proforma', blank=True, to='silver.Invoice', null=True, on_delete=models.PROTECT),
        ),
        migrations.AlterField(
            model_name='provider',
            name='country',
        ...
        migrations.AlterField(
            model_name='provider',
            name='flow',
            field=models.CharField(default='proforma', help_text='One of the available workflows for generating proformas and invoices (see the documentation for more details).', max_length=10, choices=[(b'proforma', 'Proforma'), (b'invoice', 'Invoice')]),
        ),
        migrations.AlterField(
            model_name='provider',
            name='invoice_series',
        ...
        migrations.AlterField(
            ...
            name='reference',
            field=models.CharField(blank=True, max_length=128, null=True, help_text="The subscription's reference in an external system.", validators=[django.core.validators.RegexValidator(regex='^[^,]*$', message='Reference must not contain commas.')]),
        ),
        ...
        migrations.AddField(
            ...
            name='invoice',
            field=models.ForeignKey(blank=True, to='silver.Invoice', null=True, on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='transaction',
            name='payment_method',
            field=models.ForeignKey(to='silver.PaymentMethod', on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='transaction',
            name='proforma',
            field=models.ForeignKey(blank=True, to='silver.Proforma', null=True, on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='paymentmethod',
            name='customer',
            field=models.ForeignKey(to='silver.Customer', on_delete=models.PROTECT),
        ),
