    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_reference', models.CharField(help_text=b"It's a reference to be passed between silver and clients. It usually points to an account ID.", max_length=256, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.DecimalField(max_digits=19, decimal_places=2, validators=[django.core.validators.MinValueValidator(0.0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archived_customer', jsonfield.fields.JSONField(default=dict)),
                ('archived_provider', jsonfield.fields.JSONField(default=dict)),
                ...
                ('pdf', models.FileField(upload_to=silver.models.documents_pdf_path, null=True, editable=False, blank=True)),
                ('state', django_fsm.FSMField(default=b'draft', help_text=b'The state the invoice is in.', max_length=10, verbose_name=b'State', choices=[(b'draft', b'Draft'), (b'issued', b'Issued'), (b'paid', b'Paid'), (b'canceled', b'Canceled')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(help_text=b'The feature display name.', max_length=200)),
                ('unit', models.CharField(max_length=20)),
                ('price_per_unit', models.DecimalField(help_text=b'The price per unit.', max_digits=8, decimal_places=2, validators=[django.core.validators.MinValueValidator(0.0)])),
                ('included_units', models.DecimalField(help_text=b'The number of included units per plan interval.', max_digits=19, decimal_places=2, validators=[django.core.validators.MinValueValidator(0.0)])),
                ('included_units_during_trial', models.DecimalField(decimal_places=2, validators=[django.core.validators.MinValueValidator(0.0)], max_digits=19, blank=True, help_text=b'The number of included units during the trial period.', null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('consumed_units', models.DecimalField(max_digits=19, decimal_places=2, validators=[django.core.validators.MinValueValidator(0.0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(help_text=b'Display name of the plan.', max_length=200)),
                ('interval', models.CharField(default=b'month', help_text=b'The frequency with which a subscription should be billed.', max_length=12, choices=[(b'day', b'Day'), (b'week', b'Week'), (b'month', b'Month'), (b'year', b'Year')])),
                ('interval_count', models.PositiveIntegerField(help_text=b'The number of intervals between each subscription billing')),
                ('amount', models.DecimalField(help_text=b'The amount in the specified currency to be charged on the interval specified.', max_digits=8, decimal_places=2, validators=[django.core.validators.MinValueValidator(0.0)])),
                ...
                ('trial_period_days', models.PositiveIntegerField(help_text=b'Number of trial period days granted when subscribing a customer to this plan.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', django_fsm.FSMField(default=b'draft', help_text=b'The state the invoice is in.', max_length=10, verbose_name=b'State', choices=[(b'draft', b'Draft'), (b'issued', b'Issued'), (b'paid', b'Paid'), (b'canceled', b'Canceled')])),
                ('customer', models.ForeignKey(to='silver.Customer')),
                ('invoice', models.ForeignKey(related_name='related_invoice', blank=True, to='silver.Invoice', null=True)),
            ],
            options={
                'ordering': ('-issue_date', 'number'),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zip_code', models.CharField(max_length=32, null=True, blank=True)),
                ('extra', models.TextField(help_text=b'Extra information to display on the invoice (markdown formatted).', null=True, blank=True)),
                ('flow', models.CharField(default=b'proforma', help_text=b'One of the available workflows for generating proformas and                   invoices (see the documentation for more details).', max_length=10, choices=[(b'proforma', b'Proforma'), (b'invoice', b'Invoice')])),
                ...
                ('default_document_state', models.CharField(default=b'draft', help_text=b'The default state of the auto-generated documents.', max_length=10, choices=[(b'draft', b'Draft'), (b'issued', b'Issued')])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(help_text=b"The subscription's reference in an external system.", max_length=128, null=True, blank=True)),
                ('state', django_fsm.FSMField(default=b'inactive', help_text=b'The state the subscription is in.', protected=True, max_length=12, choices=[(b'active', b'Active'), (b'inactive', b'Inactive'), (b'canceled', b'Canceled'), (b'ended', b'Ended')])),
        ...
        migrations.AddField(
            model_name='plan',
            name='product_code',
            field=models.OneToOneField(to='silver.ProductCode', help_text=b'The product code for this plan.'),
        ),
        migrations.AddField(
            model_name='plan',
            name='provider',
        ...
        migrations.AddField(
            ...
            name='product_code',
            field=silver.models.UnsavedForeignKey(help_text=b'The product code for this plan.', to='silver.ProductCode'),
        ),
        migrations.AddField(
            model_name='invoice',
            name='proforma',
            field=models.ForeignKey(related_name='related_proforma', blank=True, to='silver.Proforma', null=True),
        ),
        migrations.AddField(
            model_name='invoice',
            name='provider',
        ...
        migrations.AddField(
            ...
            name='invoice',
            field=models.ForeignKey(related_name='invoice_entries', blank=True, to='silver.Invoice', null=True),
        ),
        migrations.AddField(
            model_name='documententry',
            name='product_code',
        ...
        migrations.AddField(
            model_name='documententry',
            name='proforma',
            field=models.ForeignKey(related_name='proforma_entries', blank=True, to='silver.Proforma', null=True),
        ),
        migrations.AddField(
            model_name='billinglog',
            name='invoice',
            field=models.ForeignKey(related_name='billing_log_entries', blank=True, to='silver.Invoice', null=True),
        ),
        migrations.AddField(
            model_name='billinglog',
            name='proforma',
            field=models.ForeignKey(related_name='billing_log_entries', blank=True, to='silver.Proforma', null=True),
        ),
        migrations.AddField(
            model_name='billinglog',
            name='subscription',
