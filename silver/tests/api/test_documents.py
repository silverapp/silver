...
class TestDocumentEndpoints(APITestCase):
    ...
    def _get_expected_data(self, document, transactions=None):
        kind = six.text_type(document.kind.lower())
        transactions = [{
        ...
        return {
            ...
            u'due_date': six.text_type(document.due_date) if document.due_date else None,
            u'issue_date': six.text_type(document.issue_date) if document.issue_date else None,
