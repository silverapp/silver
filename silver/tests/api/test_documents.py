...
class TestDocumentEndpoints(APITestCase):
    ...
    def _get_expected_data(self, document, transactions=None):
        kind = smart_text(document.kind.lower())
        transactions = [{
        ...
        return {
            ...
            u'due_date': smart_text(document.due_date) if document.due_date else None,
            u'issue_date': smart_text(document.issue_date) if document.issue_date else None,
