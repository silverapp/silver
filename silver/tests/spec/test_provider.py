...
class TestProviderEndpoints(APITestCase):
    ...
    def test_get_provider(self):
        ...
        expected = {
            ...
            'display_email': provider.display_email,
            'internal_email': provider.internal_email,
    ...
    def test_patch_provider(self):
        ...
        assert response.data == {
            ...
            'proforma_series': 'ProformaSeries',
            'proforma_starting_number': 1,
            'display_email': 'display1@email.com',
            'internal_email': 'internal1@email.com',
            'address_1': 'Address11',
            'address_2': u'Addåress21',
            'city': 'City1',
            'state': 'State1',
